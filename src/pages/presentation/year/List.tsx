...
const List = () => {
    ...
    const [orderColumn, setOrderColumn] = useState<string>('date_start');
    ...
    return (
        <PageWrapper title={dashboardPagesMaster.year.subMenu.list.text}>
            <SubHeader>
                <SubHeaderLeft>
            ...
            <Page>
                <Card stretch data-tour='list'>
                    <CardHeader>
                        <CardLabel icon={dashboardPagesMaster.year.subMenu.list.icon} iconColor='info'>
                            <CardTitle>
                                Edições{' '}
                    ...
                    <CardBody className='table-responsive' isScrollable>
                        <table className='table table-modern table-hover'>
                            ...
                            <tr>
                                ...
                                <th scope='col'
                                    onClick={() => setOrder('date_start')}
                                    className='cursor-pointer text-decoration-underline'>
                                    Data inicio
                                    <Icon
                                        size='lg'
                                        className={orderColumn === 'date_start' && orderBy === 'ASC' ? 'AddRoad ascending' : 'AddRoad descending'}
                                        icon='FilterList'
                                    />
                                </th>

                                <th scope='col'
                                    onClick={() => setOrder('date_end')}
                                    className='cursor-pointer text-decoration-underline'>
                                    Data Fim
                                    <Icon
                                        size='lg'
                                        className={orderColumn === 'date_end' && orderBy === 'ASC' ? 'AddRoad ascending' : 'AddRoad descending'}
                                        icon='FilterList'
                                    />
                                </th>
                            </tr>
